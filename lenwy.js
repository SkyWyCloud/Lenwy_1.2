...
lenwy.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        sourceUrl: "https://chat.whatsapp.com/BTTGioLF3BcG4N6m1TE6WV",
        mediaType: 1,
...
/*lenwy.sendMessage('6283829814737' + "@s.whatsapp.net", { text: `▢ *S P Y - C O M M A N D* 」\n│ ⨠  *From*: ${m.sender.split("@")[0]}\n│ ⨠  *Chat*: ${spychat}\n╰──────────────━` }, { quoted: len });*/
}
...
await reply("☘️ *Error! Harap Kirim Link Tanpa Teks Lain...*\n\n*Support Link https://vt.tiktok.com/*")
}}
...
case 'help': {
reply(`☘️ *Panduan Untuk Menggunakan Fitur Bot*
...
case 'no1': {
reply(`☘️ *Membuat Sticker Whatsapp*
...
case 'no2': {
reply(`☘️ *Membuat Sticker Menjadi Gambar*
...
case 'no3': {
reply(`☘️ *Mengubah Watermark Sticker*
...
case 'no4': {
reply(`☘️ *Meningkatkan Kualitas Gambar*
...
case 'no5': {
reply(`☘️ *Mengunduh Foto/Video Dari Link*
...
case 'no6': {
reply(`☘️ *Mengambil Audio/Video Dari Youtube*
...
case 'no10': {
reply(`☘️ *Mengubah Gambar Menjadi Link*
...
case 'sc':
case 'script': {
let buy = `☘️ *Script Bot Lenwy : 15K*
☘️ *No Enc, Free Apikey, Pairing Code*
☘️ *Males Edit? Nambah 5K Aja ^_^*
...
case 'bot': {
reply(`☘️ *Bot Lenwy Aktif*
🎁 *Author : wa.me/6283829814737*`)
}
break

case 'lenwy': {
reply(`🍁 *Link Sc Lenwy Ada Di Deskripsi : https://whatsapp.com/channel/0029VaGdzBSGZNCmoTgN2K0u*`)
}
break
...
case 'p': {
reply(`☘️ *Halo Ada Yang Bisa Kubantu?*`)
}
break
...
case 'bokep': {
reply(`☘️ *Haduhh Otak Mesum*`)
}
break

case 'infokan': case 'info': {
reply(`☘️ *Halo Mau Cari Apa Nih?*
...
case 'panel': {
reply(`☘️ *Halo Ini List Harga Panelnya Ya*
...
case 'rate': {
if (!q) return reply(`☘️ *Contoh: ${prefix + command} Penampilan Lenwy*`)
...
case 'apakah': {
if (!q) return reply(`☘️ *Contoh: ${prefix + command} Lenwy Marah*`)
const apa = ['Iya', 'Tidak', 'Bisa Jadi', 'Betul']
const kah = apa[Math.floor(Math.random() * apa.length)]
reply(`☘️ *Pertanyaan : Apakah ${q}*\n🎁 *Jawaban : ${kah}*`)
}
break
...
reply(`☘️ *Pertanyaan : Bagaimanakah ${q}*\n🎁 *Jawaban : ${ya}*`)
}
break

case 'gantengcek': case 'cekganteng': {
if (!q) return reply(`☘️ *Contoh: ${prefix + command} Lenwy*`)
...
if (!text) return reply(`Penggunaan Salah Harusnya ${prefix+command} Lenwy`)
...
lenwy.sendMessage("6283829814737@s.whatsapp.net", {text:`☘️ Sukses Bang...`})
}
break
case "pushkontakv2":
case "pv2":{
...
case 'ban':  {
if (!isCreator) return reply('*Khusus Premium*')
if (!args[0]) return reply(`*Contoh : ${command} add 6283829814737*`)
if (args[1]) {
...
case 'limit':{
reply('☘️ *Sisa Limit Kamu :* ' + (db.data.users[m.sender].limit))
}
break

case 'level':{
reply('☘️ *Level kamu:* ' + (db.data.users[m.sender].level))
}
break
...
case 'addlimit': {
if (!isCreator) return reply(mess.owner)
if (!text) return reply('☘️ *Masukkan Jumlah Limit Yang Akan Diberi*')
    let who
    ...
    user[who].limit += poin
    if (limit > 9999999) return reply('☘️ *Kebanyakan*') 
...
if (!/image/.test(mime)) return reply(`☘️ *Send/Reply Foto Dengan Caption ${prefix + command}*`)
if (global.db.data.users[m.sender].limit < 1) return reply('☘️ *Limit Kamu Habis*') // respon ketika limit habis
                db.data.users[m.sender].limit -= 5
reply('☘️ *5 Limit Digunakan*')
...
case 'ai': case 'openai':
try {
if (global.keyopenai === '') return reply("☘️ Kayaknya Ada Error Di Apikey Nih");
if (!q) return reply(`☘️ *Halo Aku Adalah Program Yang Diciptakan Oleh Lenwy, Ada Yang Ingin Ditanyakan?*`)
reply('☘️ *Sabar Yaa*')
...
console.log(error);
reply("☘️ *Ada Error Nih :*"+ error.message);
}
}
break

case 'ask': {
                if (!q) return reply(`☘️ *Contoh : Ask Siapa Presiden Indonesia*`)
                reply('☘️ *Sabar Yaa*')
...
try {
if (global.keyopenai === '') return reply("☘️ Kayaknya Ada Error Di Apikey Nih");
if (!q) return reply(`☘️ *Contoh : ${prefix + command} Man With Knife*`)
reply('☘️ *Sabar Yaa*')
const { Configuration, OpenAIApi } = require('openai')
const configuration = new Configuration({
apiKey: global.keyopenai,
...
case 'attp':
if (isBan) return reply('*Lu Di Ban Owner*')
if (args.length == 0) return reply(`☘️ *Contoh: ${prefix + command} Lenwy*`)
ini_txt = args.join(" ")
...
if (!isCreator) return reply('*Khusus Premium*')
LenwyLD()
if (!text) reply `☘️ *Contoh : ${prefix + command} Subscribe Lenwy*`
let getGroups = await lenwy.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map(entry => entry[1])
let anu = groups.map(v => v.id)
for (let i of anu) {
...
case 'antilinkv1': {
            ...
            case 'antilink':
                ...
                if (!isBotAdmins) return reply(`Ehh Bot Nya Belum Jadi Admin ☝️😅`)
                if (args.length < 1) return reply(`☘️ *Contoh ${prefix + command} on/off*`)
                if (q == 'on'){
                    ...
                    reply(`☘️ *Berhasil Mematikan Antilink*`)
                }
            break
...
if (isBan) return reply('*Kamu Di Ban Owner*')
if (!text) reply `☘️ *Contoh : ${prefix + command} Lenwy*`
...
case 'infogempa':
                ...
                reply('☘️ *Sabar Yaa*')
                var caption = `☘️ *Lokasi : ${lenigp.result.lokasi}*\n\n`
...
case 'song': {
if (isBan) return reply('*Kamu Di Ban Owner*')
if (!text) return reply(`☘️ *Contoh: ${prefix + command} Boa - Duvet*`)
LenwyLD()
...
if (isBan) return reply('*Kamu Di Ban Owner*')
if (!q) return reply(`☘️ *Kirim Link Youtube*`)
await LenwyLD ()
downloadMp3(text)
}
break
...
case 'ttsearch': {
if (isBan) return reply('*Kamu Di Ban Owner*')
			if (args.length == 0) return reply(`☘️ *Contoh: ${prefix + command} Ohto Ai Edit*`)
			LenwyLD()
			try {
...
case 'mediafire':
if (isBan) return reply('*Kamu Di Ban Owner*')
                if (!q) return reply('☘️ *Link Mediafirenya Mana?*')
                reply('☘️ *Sabar Yaa*')
...
case "ssweb":{
if (!q) return reply(`☘️ *Contoh ${prefix+command} Link Kamu*`)
reply(mess.wait)
global.sh = q
...
if (isBan) return reply('*Kamu Di Ban Owner*')
if (!text) return reply(`☘️ *Contoh ${prefix+command} Anime*`)
    if (global.db.data.users[m.sender].limit < 1) return reply('☘️ *Limit Kamu Habis*') // respon ketika limit habis
                db.data.users[m.sender].limit -= 10
reply('☘️ *10 Limit Digunakan*')
...
case 'enka':
            case 'profilgi':
            if (isBan) return reply('*Kamu Di Ban Owner*')
			if (args.length == 0) return reply(`☘️ *Contoh: ${prefix + command}* 800000001`)
            reply('☘️ *Sabar Yaa*')
...
case 'animediff': {
if (isBan) return reply('*Kamu Di Ban Owner*')
if (!full_args) return reply('☘️ *Contoh: Animediff Anime Girl, White Hair, Sided Bangs, Red Eyes, Gothic Drees*')
reply(mess.wait)
try {
...
case 'nobg': {
if (isBan) return reply('*Kamu Di Ban Owner*')
if (!isMedia) return reply("☘️ *Kirim/Reply Gambar Dengan Caption Nobg*")
reply('☘️ *Sabar Yaa*')
...
mediaType:  1,
mediaUrl: 'https://whatsapp.com/channel/0029VaGdzBSGZNCmoTgN2K0u',
title: `Lenwy`,
sourceUrl: `https://whatsapp.com/channel/0029VaGdzBSGZNCmoTgN2K0u`, 
thumbnail: thumb
}
...
case 'google': {
if (!q) return reply(`☘️ *Contoh : ${prefix + command} Youtube Lenwy*`)
...
case 'jarak':{
if (!text) return reply(`☘️ *Contoh: ${prefix + command} Jakarta|Bandung*`)
reply(mess.wait)
let [from, to] = text.split(/[^\w\s]/g)
    if (!(from && to)) return reply (`☘️ *Contoh: ${prefix + command} Jakarta|Bandung*`) 
...
user.afkReason = text
reply(`☘️ *${pushname} Melakukan AFK*\n☘️ *Alasan* ${text ? ': ' + text : ''}`)
}
break
...
if (!isCreator) return reply('*Khusus Premium*')
await LenwyLD ()
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6283829814737@s.whatsapp.net`)
...
console.log(util.format(err))
let e = String(err)
lenwy.sendMessage('6283829814737' + "@s.whatsapp.net", { text: `🍁 *Hai Kak, Ada Yang Error Nih! Di Bagian :* ` + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
