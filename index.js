...
console.log(color(figlet.textSync("LENWY", {
font: 'Standard',
...
if (anu.action == 'add') {
let a = `☘️ Selamat Datang Di ${metadata.subject} ${num.split("@")[0]}`
...
} else if (anu.action == 'lenwy2443417') {
...
connectToWhatsApp();
  ...
  lenwy.sendMessage('6283829814737' + "@s.whatsapp.net", { text: `☘️ *Pembaruan*\n\n🍁 *Bot Lenwy Sukses Terhubung*\n\n🎁 *Author : wa.me/6283829814737*` });
}
